...
var NgxImageZoomComponent = (function () {
    function NgxImageZoomComponent(renderer) {
        ...
        this.onZoomStateChange = new EventEmitter();
    ...
    function () {
        ...
        if (this.zoomMode === 'hover') {
            ...
            this.renderer.listen(this.zoomContainer.nativeElement, 'mouseenter', function (event) { return _this.hoverClickMouseEnter(event); });
            this.renderer.listen(this.zoomContainer.nativeElement, 'mouseleave', function (event) { return _this.hoverClickMouseLeave(event); });
     ...
     * @return {?}
     */
    NgxImageZoomComponent.prototype.hoverClickMouseEnter = /**
     * Hover click mode
     * @param {?} event
     * @return {?}
     */
     ...
     * @return {?}
     */
    NgxImageZoomComponent.prototype.hoverClickMouseLeave = /**
     * @param {?} event
     * @return {?}
     */
    function (event) {
     ...
     * @return {?}
     */
    NgxImageZoomComponent.prototype.hoverClickMouseMove = /**
     * @param {?} event
     * @return {?}
     */
    function (event) {
     ...
     * @return {?}
     */
    NgxImageZoomComponent.prototype.hoverClickMouseClick = /**
     * @param {?} event
     * @return {?}
     */
    function (event) {
     ...
     */
    function () {
        this.thumbWidth = this.imageThumbnail.nativeElement.parentElement.clientWidth;
        var /** @type {?} */ ratio = this.thumbWidth / this.imageThumbnail.nativeElement.naturalWidth;
        this.thumbHeight = ratio * this.imageThumbnail.nativeElement.naturalHeight;
        ...
        if (this.fullImageLoaded) {
            ...
            if (this.fullWidth < this.thumbWidth) {
                this.fullWidth = this.thumbWidth;
                this.fullHeight = this.thumbHeight;
            }
